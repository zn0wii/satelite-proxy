...
const en = {
  ...
  "rules.rulePreviewLabel": "Rules preview",
  "rules.rulePreviewMore": "+{n} more",
  "rules.mixedSetHint":
    "This set has mixed per-rule routes. Changing it will overwrite all of them.",
  "rules.batchOverwriteHint": "Change overwrites all nodes",
...
const zh: Record<MessageKey, string> = {
  ...
  "rules.rulePreviewLabel": "规则预览",
  "rules.rulePreviewMore": "还有 {n} 条",
  "rules.mixedSetHint": "当前规则集带有多种规则，如果修改将会整体覆盖。",
  "rules.batchOverwriteHint": "改动将会覆盖全部节点",
