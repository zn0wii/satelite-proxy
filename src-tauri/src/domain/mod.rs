...
pub use rule::{
    ...
    remote_update_interval_secs, rules_contain_ip_cidr, sanitize_rules, BuiltinRemoteRuleSpec,
    RemoteRuleSetConfig, Rule, RuleSet, RuleSetDnsStrategy, RuleSetOwnership, RuleSetStrategy,
    RuleSetSummary, RuleTarget, RuleType, BUILTIN_REMOTE_RULE_SETS, BUILTIN_SET_ID,
